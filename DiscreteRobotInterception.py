...
class DiscreteRobotMovingEnv(gym.Env):
    ...
    def __init__(self, render_mode: Optional[str] = None):
        ...
        self.low = np.array([0, 0, -int(self.img_width/2)], dtype=int)
        self.high = np.array([self.img_width, self.img_width, self.img_width], dtype=int)
    ...
    def reset(
        ...
        *,
        ...
        self.state = np.array([bbox_middle, bbox_width, bbox_bias]).astype(int)
